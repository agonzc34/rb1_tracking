...
class TrackingPublisher(Node):
    ...
    def __init__(self):
        ...
        self.image_sub_ = Subscriber(self, Image, "/head_front_camera/rgb/image_raw", 10)
        self.bounding_boxes_sub_ = Subscriber(self, BoundingBoxes, "/obj_rec/bounding_boxes", 10)
